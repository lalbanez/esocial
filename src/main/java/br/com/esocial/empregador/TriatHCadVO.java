...
@Table(name="TSOC_HCAD_EMPREGADOR", schema="ESOCIAL")
public class TriatHCadVO {
...
//	
	...
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "sequenceHCadEmpregador")
	@SequenceGenerator(name = "sequenceHCadEmpregador", sequenceName = "ESOC_SEQ_ID_HCAD_EMPREGADOR" )
	private Integer idHistEmpregador;
