...
@Component
public class WebServiceEnvioEsocial {
...
//	@Scheduled(cron = "0 0-59/1 * * * ?")
	public void enviaEsocial() {
		...
		log.info(">>>>>>> Inicio Processamento Envio de Lote de Eventos <<<<<<<<<<" + dateFormat.format(dataInicio));
		System.out.println(">>>>>>> Inicio Processamento Envio de Lote de Eventos <<<<<<<<<<" + dateFormat.format(new Date()));
